...
class GetTextTheme {
  ...
  static TextStyle sf35_bold =
      GoogleFonts.roboto(fontSize: 35, fontWeight: FontWeight.w700);
  ...
  static TextStyle sf10_bold =
      GoogleFonts.roboto(fontSize: 10, fontWeight: FontWeight.w700);

  //Medium Text
  static TextStyle sf40_medium =
      GoogleFonts.roboto(fontSize: 40, fontWeight: FontWeight.w500);
  static TextStyle sf35_medium =
      GoogleFonts.roboto(fontSize: 35, fontWeight: FontWeight.w500);
  ...
  static TextStyle sf26_medium =
      GoogleFonts.roboto(fontSize: 26, fontWeight: FontWeight.w500);
  ...
  static TextStyle sf40_regular =
      GoogleFonts.roboto(fontSize: 40, fontWeight: FontWeight.w400);
  static TextStyle sf35_regular =
      GoogleFonts.roboto(fontSize: 35, fontWeight: FontWeight.w400);
  static TextStyle sf32_regular =
      GoogleFonts.roboto(fontSize: 32, fontWeight: FontWeight.w400);
